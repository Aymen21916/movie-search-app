  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Details about the movie: ${media.title || media.name}`} />
        <link rel="icon" href={`${"https://image.tmdb.org/t/p"}/w500${media.poster_path}`} className='w-10 h-10 rounded-full'/>
      </Head>
